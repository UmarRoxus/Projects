...
if __name__ == "__main__": 
    ...
    gui.title("Umar's Calculator") 
  
    # set the configuration of GUI window 
    gui.geometry("294x123")

    # prevents user from increasing GUI window size
    gui.resizable(0, 0) 
    ...
    remainder = Button(gui, text=' Remainder ', fg='black', bg='white', 
                    command=lambda: press("%"), height=1, width=7) 
    remainder.grid(row=3, column=4)

    lessthan = Button(gui, text=' < ', fg='black', bg='white', 
                    command=lambda: press("<"), height=1, width=7) 
    lessthan.grid(row=4, column=4)

    greaterthan = Button(gui, text=' > ', fg='black', bg='white', 
                    command=lambda: press(">"), height=1, width=7) 
    greaterthan.grid(row=5, column=4)
